...
urlpatterns = [
    ...
    path('food/<int:food_id>/review', food_views.FoodReviewViewSet.as_view(), name='food-review'),
    path('food/<int:food_id>/rating', food_views.FoodRatingViewSet.as_view(), name='food-rating'),
    ...
    path('restaurant/<int:restaurant_id>/review', restaurant_views.RestaurantReviewViewSet.as_view(), name='restaurant-review'),
    path('restaurant/<int:restaurant_id>/rating', restaurant_views.RestaurantRatingViewSet.as_view(), name='restaurant-rating'),
